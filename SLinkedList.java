...
public class SLinkedList<E extends DeepClone<E>> implements Iterable<E>
{
	...
	/*
 	 *  Makes a deep copy of the this linked list.
 	 */
 	public SLinkedList<E> deepClone()
 	{
 		SLinkedList<E> copy = new SLinkedList<E>();
 		for(E e: this){
			Term termToCopy = (Term) e;
			Term copiedTerm = new Term(termToCopy.getExponent(), termToCopy.getCoefficient());
			copy.addLast((E)copiedTerm);
		}
 		return copy;
 	}
